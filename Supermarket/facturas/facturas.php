          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td class="row justify-content-center gap-2 col-10">
                <a class="btn btn-danger" href="./borrarFactura.php?id=<?= $val['factura_id'] ?>&req=delete">BORRAR</a>
                <a class="btn btn-primary" href="./actualizarFactura.php?id=<?=$val['factura_id']?>">Editar</a>
              </td>
            </tr>
