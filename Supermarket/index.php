<?php
  require_once('./categorias/config.php');
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./categorias/css/styles.css">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td class="row justify-content-center gap-2 col-10">
                <a class="btn btn-danger" href="./categorias/borrarCategoria.php?id=<?= $val['categoria_id'] ?>&req=delete">BORRAR</a>
                <a class="btn btn-primary" href="./categorias/actualizarCategorias.php?id=<?=$val['categoria_id']?>">Editar</a>
              </td>
            </tr>
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" >
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="./categorias/registrarCategoria.php" method="post">
