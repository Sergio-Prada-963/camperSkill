          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td class="row justify-content-center gap-2 col-10">
                <a class="btn btn-danger" href="./borrarEmpleados.php?id=<?= $val['empleado_id'] ?>&req=delete">BORRAR</a>
                <a class="btn btn-primary" href="./actualizarEmpleados.php?id=<?=$val['empleado_id']?>">Editar</a>
              </td>
            </tr>
