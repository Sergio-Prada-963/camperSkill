          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td class="row justify-content-center gap-2 col-10">
                <a class="btn btn-danger" href="../actions/empleados/borrarEmpleados.php?id=<?= $val['empleado_id'] ?>&req=delete">BORRAR</a>
                <a class="btn btn-primary" href="../actions/empleados/actualizarEmpleados.php?id=<?=$val['empleado_id']?>">Editar</a>
              </td>
            </tr>
      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" >
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="../actions/empleados/registrarEmpleados.php" method="post">
